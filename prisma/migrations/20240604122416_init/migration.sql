/*
  ...
  - Added the required column `path` to the `sections` table without a default value. This is not possible if the table is not empty.
...
INSERT INTO "new_sections" ("projectId", "section_file_count", "section_id", "section_name") SELECT "projectId", "section_file_count", "section_id", "section_name" FROM "sections";
DROP TABLE "sections";
